...
class Dashboard extends React.Component {
    ...
    handleClick(e) {
        ...
        this.setState({range: e.target.value}, () => {
            ...
            this.getPortfolioPrices().then(() => this.props.buildPortfolioValues())
        });
    }
    ...
    handleDepositSubmit(e) {
        ...
        this.setState({ depositAmount: 0.00, depositFormStatus: false, buyingPowerStatus: false}, () => this.props.addFunds(addAmount, this.props.user.id));
    }
    ...
    render() {
            ...
            const renderLineChart = (
                <LineChart width={676} height={196} data={this.props.portfolioValues}
                    onMouseMove={this.cursorHover}>
                    <Tooltip content={<CustomToolTip range={this.props.range}/>}
                        position={{y: 0}}
        ...
        return (
            ...
            <div className='dashboard'>
                ...
                <div className={this.state.range === '1D' ? 'main-chart-1d' : 'main-chart-rest'}>{renderLineChart}</div>
