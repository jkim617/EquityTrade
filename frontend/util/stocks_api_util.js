...
export const fetchGeneralNews = () => {
    return $.ajax({
        method: 'GET',
        // url: `https://cloud.iexapis.com/stable/time-series/news/?range=last-week&limit=10&token=${prod_key}`
        url: `https://sandbox.iexapis.com/stable/time-series/news/?range=last-week&limit=10&token=${test_key}`
    })
}
